...
def test_cases(ptses):
    ...
    custom_test_cases = [
        ...
        TTestCase("L2CAP", "L2CAP/LE/CFC/BV-04-C",
                  pre_conditions +
                  [TestFunc(lambda: stack.l2cap.psm_set(psm_unsupported))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/LE/CFC/BV-11-C",
                  pre_conditions_authen,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/LE/CFC/BV-13-C",
                  pre_conditions_author,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/LE/CFC/BV-15-C",
        ...
        TTestCase("L2CAP", "L2CAP/COS/ECFC/BV-04-C",
                  ...
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-11-C",
                  pre_conditions_authen,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-13-C",
                  pre_conditions_author,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-15-C",
                  pre_conditions_keysize,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-24-C",
                  pre_conditions_success +
                  [TestFunc(lambda: pts.update_pixit_param("L2CAP", "TSPX_l2ca_cbmps_max", format(64, '04x')))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-25-C",
                  pre_conditions_success +
                  [TestFunc(lambda: stack.l2cap.num_channels_set(1))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-29-C",
                  pre_conditions_success +
                  [TestFunc(lambda: stack.l2cap.num_channels_set(1))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BV-32-C",
                  pre_conditions_authen,
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BI-01-C",
                  pre_conditions_success +
                  [TestFunc(lambda: stack.l2cap.num_channels_set(1))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BI-02-C",
                  pre_conditions_success +
                  [TestFunc(lambda: stack.l2cap.num_channels_set(1)),
                   TestFunc(lambda: stack.l2cap.hold_credits_set(1))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/ECFC/BI-07-C",
                  pre_conditions_success +
                  [TestFunc(lambda: stack.l2cap.hold_credits_set(1))],
                  generic_wid_hdl=l2cap_wid_hdl),
        TTestCase("L2CAP", "L2CAP/TIM/BV-03-C",
                  pre_conditions_success +
    ...
    for tc_name in test_case_name_list:
        instance = TTestCase('L2CAP', tc_name,
                             pre_conditions_success,
                             generic_wid_hdl=l2cap_wid_hdl)
