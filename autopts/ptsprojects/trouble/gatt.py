...
from autopts.ptsprojects.trouble.gatt_wid import gatt_wid_hdl
...
def set_pixits(ptses):
    ...
    pts.set_pixit("GATT", "TSPX_bearer_for_le", "ATT")
...
def test_cases_server(ptses):
    ...
    custom_test_cases = [
        TTestCase("GATT", "GATT/SR/GAN/BV-02-C",
    ...
    for tc_name in test_case_name_list:
        if not tc_name.startswith('GATT/SR'):
            continue
        instance = TTestCase('GATT', tc_name,
...
def test_cases_client(pts):
    ...
    custom_test_cases = [
        # PTS issue #15965
        # TTestCase("GATT", "GATT/CL/GAW/BV-02-C",
    ]
