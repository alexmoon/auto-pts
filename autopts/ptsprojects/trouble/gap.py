...
from autopts.ptsprojects.trouble.gap_wid import gap_wid_hdl
...
from autopts.pybtp.types import UUID, Addr, AdFlags, AdType, IOCap, Perm, Prop, UriScheme
...
def test_cases(ptses):
    ...
    custom_test_cases = [
        ...
        TTestCase("GAP", "GAP/SEC/SEM/BV-22-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-23-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-24-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-26-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-27-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-28-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-29-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-58-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BV-61-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-09-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-10-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-20-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-21-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-22-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
        TTestCase("GAP", "GAP/SEC/SEM/BI-23-C",
                  cmds=le_sc_only,
                  generic_wid_hdl=gap_wid_hdl),
    ]
    ...
    for tc_name in test_case_name_list:
        instance = TTestCase('GAP', tc_name,
